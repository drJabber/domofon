...
from app.api.dependencies.authentication import get_current_user_authorizer, get_current_client_authorizer
...
from app.models.schemas.clients import ClientInResponse, ClientInUpdate, ClientWithToken
...
@router.get("", response_model=ClientInResponse, name="users:get-current-user")
